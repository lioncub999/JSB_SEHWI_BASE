        ...
        <c:forEach items="${chickenList}" var="chicken">
            <div class="calories-content" style="width: 220px">
                ...
                <div style="display: flex;">
                    <button onclick="AjaxFunc.plusOneChicken(${chicken.consumer}, '${chicken.userNm}', 'HT01')"
                            type="button" class="btn btn-primary" style="margin : auto; background: ivory; width: 70px">
                        갈릭
                    </button>
                    <button onclick="AjaxFunc.plusOneChicken(${chicken.consumer}, '${chicken.userNm}', 'HT02')"
                            type="button" class="btn btn-primary"
                            style="margin : auto; background: darkred; color: white; width: 70px">핫양념
                    </button>
                    <button onclick="AjaxFunc.plusOneChicken(${chicken.consumer}, '${chicken.userNm}', 'HT03')"
                            type="button" class="btn btn-primary"
                ...
                <div style="display: flex;">
                    <button onclick="AjaxFunc.plusOneChicken(${chicken.consumer}, '${chicken.userNm}', 'HT04')"
                            type="button" class="btn btn-primary"
                            style="margin : auto; background: orangered; color: white; width: 70px">떡볶이
                    </button>
                    <button onclick="AjaxFunc.plusOneChicken(${chicken.consumer}, '${chicken.userNm}', 'HT05')"
                            type="button" class="btn btn-primary"
